...
public partial class edit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string sql = @"select goodsName,count,badContent,produceTime,eployeeName,produceArea
            ...
            TextemployeeName.Text = (string)dt.Rows[0]["eployeeName"];
        }
    }
        ...
        else
        {
            ...
            string sql = @"update shatter_Parts set
                              goodsName='" + goodsName + "',count='" + count + "',price='" +
                                       ...
                                       + badcontent + "',produceTime=" + produceTime + ",eployeeName='" +
                                       employeeName + "',produceArea='" +
                                       produceArea + "',spec='" + spec + "' where id=" + id + "";
            Debug.WriteLine(sql);
