    ...
    <div>
        <table runat="server">
            ...
            <tr>
                ...
                <td style="width: 13%">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBoxbadcontent"
                        ErrorMessage="输入不能为空"></asp:RequiredFieldValidator>
                    <textarea id="TextBoxbadcontent" rows="4" cols="15" runat="server" style="width: 216px;
                        height: 67px; resize: none;"></textarea>
                </td>
                <td style="width: 13%">
