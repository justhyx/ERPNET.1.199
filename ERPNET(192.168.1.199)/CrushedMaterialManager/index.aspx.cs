...
public partial class index : System.Web.UI.Page
{
    ...
    string sqlquery = @"select ID,goodsName,count ,price , moneySum ,ISNULL(CONVERT(nvarchar(10),  inputTime,126),'') as inputTime,
                            badContent ,ISNULL( CONVERT(nvarchar(10),  produceTime,126),'') as produceTime,eployeeName ,spec,produceArea,                                                       
                            ...
                            from shatter_Parts where topManagerConfirm is null and managerConfirm is null
                            and ({0})";
