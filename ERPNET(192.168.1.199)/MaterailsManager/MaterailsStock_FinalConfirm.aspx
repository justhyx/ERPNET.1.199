<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterailsStock_FinalConfirm.aspx.cs"
    Inherits="ERPPlugIn.MaterailsManager.MaterailsStock_FinalConfirm" EnableEventValidation="false"
    UICulture="auto" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title><asp:Literal ID="Literal3" Text="<%$ Resources:Resource, pdbsh%>" runat="server" /></title>
        ...
        <table width="100% " border="1" align="center" cellpadding="4" cellspacing="0" style="border-color: #7E7E7E">
            <tr>
                <td colspan="3" align="center" style="font-size: 18px; font-weight: bold;">
                    <asp:Literal ID="Literal1" Text="<%$ Resources:Resource, pdbsh%>" runat="server" />
                </td>
            </tr>
            <tr>
                <td align="center">
