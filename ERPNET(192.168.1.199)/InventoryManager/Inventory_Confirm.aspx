<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inventory_Confirm.aspx.cs"
    Inherits="ERPPlugIn.InventoryManager.Inventory_Confirm" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title><asp:Literal ID="Literal1" Text="<%$ Resources:Resource, pdbqr %>" runat="server" /></title>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="6">
            <tr>
                <td>
                    ...
                    <asp:Literal Text="<%$ Resources:Resource, pdrq %>" runat="server" />:<asp:TextBox
        ...
        <table width="100% " border="1" align="center" cellpadding="4" cellspacing="0" style="border-color: #7E7E7E">
            <tr>
                <td colspan="3" align="center" style="font-size: 18px; font-weight: bold;">
                    <asp:Literal Text="<%$ Resources:Resource, pdbqr %>" runat="server" />
                </td>
            </tr>
            <tr>
                <td colspan="3">
