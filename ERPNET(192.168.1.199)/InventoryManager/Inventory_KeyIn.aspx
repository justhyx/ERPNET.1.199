<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inventory_KeyIn.aspx.cs"
    Inherits="ERPPlugIn.InventoryManager.Inventory_KeyIn" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>
        <asp:Literal ID="Literal7" Text="<%$ Resources:Resource, pdblr%>" runat="server" />
    </title>
        ...
        <table width="100% " border="1" align="center" cellpadding="4" cellspacing="0" style="border-color: #7E7E7E">
            <tr>
                <td colspan="3" align="center" style="font-size: 18px; font-weight: bold;">
                    <asp:Literal Text="<%$ Resources:Resource, pdblr%>" runat="server" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3">
                    ...
                    <asp:Literal ID="Literal6" Text="<%$ Resources:Resource, bpmc%>" runat="server" />：
                    ...
                    <asp:Literal ID="Literal2" Text="<%$ Resources:Resource, pdbh%>" runat="server" />：
                    <asp:TextBox ID="txtPK_No" runat="server" />
                    <asp:Literal ID="Literal3" Text="<%$ Resources:Resource, bz%>" runat="server" />：
                    <asp:TextBox ID="txtRemark" runat="server" />
                    <asp:Literal ID="Literal4" Text="<%$ Resources:Resource, pdrq%>" runat="server" />：
                    <asp:TextBox ID="txtPK_Date" runat="server" Enabled="False" />
                    <asp:Literal ID="Literal5" Text="<%$ Resources:Resource, pddh%>" runat="server" />：
            ...
            <tr runat="server" id="trgoods" align="center">
                <td colspan="3">
                    <asp:GridView runat="server" ID="gvGoodsData" OnRowDataBound="gvGoodsData_RowDataBound"
                        OnSelectedIndexChanged="gvGoodsData_SelectedIndexChanged" CssClass="gv" />
                </td>
            </tr>
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView runat="server" CssClass="gv" ID="gvAddData" AutoGenerateColumns="False"
                        ...
                        OnSelectedIndexChanged="gvAddData_SelectedIndexChanged" OnRowDeleting="gvAddData_RowDeleting"
                        OnRowUpdating="gvAddData_RowUpdating">
                        <Columns>
                            <asp:TemplateField HeaderText="<%$ Resources:Resource, bpmc%>">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="<%$ Resources:Resource, kh%>">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="<%$ Resources:Resource, caozuo%>">
                                <ItemTemplate>
                                    <asp:LinkButton ID="BtnDelete" runat="server" CausesValidation="False" CommandName="Delete"
                                        Text="<%$ Resources:Resource, sc%>" OnClientClick="return confirm('Are you sure to delete this item?')"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$ Resources:Resource, caozuo%>">
                                <ItemTemplate>
