<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="M_materails_StockIn_Confirm.aspx.cs"
    Inherits="ERPPlugIn.MoldManager.M_materailsStockIn.M_materails_StockIn_Confirm"
        ...
        <table width="800 " border="1" align="center" cellpadding="4" cellspacing="0" style="border-color: #7E7E7E">
            <tr>
                <td colspan="3" align="center" style="font-size: 18px; font-weight: bold;">
                    <asp:Literal ID="Literal2" Text="入库单审核" runat="server" />
                </td>
            </tr>
            <tr>
                <td colspan="3">
