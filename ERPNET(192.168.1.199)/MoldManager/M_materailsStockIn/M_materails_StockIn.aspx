<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="M_materails_StockIn.aspx.cs"
    Inherits="ERPPlugIn.MoldManager.M_materailsStockIn.M_materails_StockIn" %>
                ...
                <td colspan="2">
                    <asp:GridView runat="server" ID="gvDetailData" Width="100%" CssClass="gv" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="qty" HeaderText="申请数量" DataFormatString="{0:0}" />
