<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockIn_AddDictateData.aspx.cs"
    Inherits="ERPPlugIn.StockInManager.StockIn_AddDictateData" %>
...
<body>
    ...
    <div>
        <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td colspan="5">
                    制令部番:<asp:Label Text="" ID="lblgoodsName" runat="server" Font-Bold="true" Font-Size="15px" />
                    &nbsp;&nbsp;&nbsp;&nbsp; 计划数：<asp:Label Text="" ID="lblDQty" runat="server" Font-Bold="true"
                        Font-Size="15px" />&nbsp;&nbsp;&nbsp;&nbsp; 已入库数量：<asp:Label Text="" ID="lblInQty"
                            runat="server" Font-Bold="true" Font-Size="15px" />&nbsp;&nbsp;&nbsp;&nbsp;
                    计划日期:<asp:Label Text="" ID="lblDDate" runat="server" Font-Bold="true" Font-Size="15px" />
                </td>
            </tr>
            <tr>
                <td colspan="5">
